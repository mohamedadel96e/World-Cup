                            ...
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-700/50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="h-10 w-10 flex-shrink-0 flex items-center justify-center rounded-lg bg-zinc-100 dark:bg-zinc-700">
                                            <img class="h-6 w-6 object-contain" src="{{ $category->icon ?? 'https://placehold.co/40x40/orange/white?text=ICON' }}" alt="{{ "N/A" }}">
                                        </div>
