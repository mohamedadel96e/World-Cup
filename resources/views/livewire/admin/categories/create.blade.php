    ...
    <div class="py-12">
        <div class="mx-auto max-w-2xl sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-zinc-800 p-8 rounded-xl shadow-lg">
                <h2 class="text-2xl font-bold mb-6 text-zinc-900 dark:text-zinc-100">Create New Category</h2>
                <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        <label for="icon" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Icon (PNG)</label>
                    ...
                    <div class="flex justify-end gap-4 pt-4 border-t border-zinc-200 dark:border-zinc-700">
                        ...
                        <button type="submit" class="rounded-md bg-orange-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-orange-500">Create Category</button>
                    </div>
                </form>
            </div>
        </div>
