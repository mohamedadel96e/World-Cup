    ...
    <div class="py-8 px-4 sm:px-8">
        <div class="max-w-lg mx-auto">
            <div class="bg-white dark:bg-zinc-800 p-8 rounded-xl shadow">
                <h2 class="text-2xl font-bold mb-6 text-zinc-900 dark:text-zinc-100">Add Country</h2>
                <form action="{{ route('admin.countries.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="code" id="code" class="input w-full" value="{{ old('code') }}"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="currency_name" id="currency_name" class="input w-full"
                                value="{{ old('currency_name') }}" required autocomplete="off">
                        ...
                        <div>
                            ...
                            <input type="text" name="currency_code" id="currency_code" class="input w-full"
                                value="{{ old('currency_code') }}" maxlength="3" required autocomplete="off">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="currency_symbol" id="currency_symbol" class="input w-full"
                                value="{{ old('currency_symbol') }}" maxlength="5" required autocomplete="off">
                        ...
                        <div>
                            ...
                            <input type="number" name="balance" id="balance" class="input w-full"
                                value="{{ old('balance', 1000000) }}" min="0" required>
